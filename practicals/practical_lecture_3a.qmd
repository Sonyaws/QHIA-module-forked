...
q1_mode_feedback = {
  ...
  return q1_mode_answer === "bus"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is Bus - it has the highest share of trips.</span>`;
}
```
...
q2_combined_feedback = {
  ...
  return isCorrect
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The combined share of bus and pedestrian is approximately ${q2_combined_answer}%.</span>`;
}
```
...
q8_feedback = {
  ...
  const row = await db.sql`SELECT correct_id FROM quiz_answers WHERE question_id = 'q8'`;
  return q8_answer === row.correct_id
    ? html`<span style="color: green; font-weight: bold;">Correct!</span>`
    : html`<span style="color: red; font-weight: bold;">Incorrect. Try again.</span>`;
}
```
