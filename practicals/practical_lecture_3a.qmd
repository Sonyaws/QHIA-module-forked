...
q3_feedback = {
  ...
  return q3_answer === "b"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is 0-2km, 2-6km, 6+km.</span>`;
}
```
...
q4_feedback = {
  ...
  return q4_answer === "b"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The y-axis represents the proportion of trips.</span>`;
}
```
...
q10_a_feedback = {
  ...
  return q10_a_answer === "b"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct formula is (10% × 80%) / 60% = 13.33%. This converts 13.33% of non-cycling trips in band A to cycling.</span>`;
}
```
...
q10_b_feedback = {
  ...
  return isCorrect
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The formula is (10% × 20%) / 40% = 5.00%. 5.00% of non-cycling trips in band B need to convert to cycling.</span>`;
}
```
...
q5_feedback = {
  ...
  return q5_answer === "a"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is trips_ped_scen <- trips_baseline.</span>`;
}
```
...
q6_feedback = {
  ...
  return q6_answer === "b"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is: Converts only non-pedestrian trips in the 0-2km category to pedestrian mode.</span>`;
}
```
...
q7_feedback = {
  ...
  return q7_answer === "c"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is 120 minutes (5 × 60 / 2.5 = 120).</span>`;
}
```
...
q8_feedback = {
  ...
  return q8_answer === "c"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is Cycle and Pedestrian.</span>`;
}
```
...
q9_feedback = {
  ...
  return q9_answer === "b"
    ...
    : html`<span style="color: red; font-weight: bold;">Incorrect. The correct answer is Cycling (5.8 mMET).</span>`;
}
```
